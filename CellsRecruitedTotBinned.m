...
%         HigherFRNC=HigherFRNC+1;
    if statsVLC.p(1,2)<=0.05 && mean(FROpenVLC)>mean(FRClosedVLC) && ((stats2VLC.p(1,2)<=0.05 && mean(FROpenVLC)>mean(FRCenterVLC)) || stats2VLC.p(1,2)>0.05)
        ...
        MatrixVLCTotNC(IndexVLC,1:20)=[FRClosedNC,FRCenterNC,FROpenNC];
        MatrixVLCTot(IndexVLC,1:20)=[FRClosedVLC,FRCenterVLC,FROpenVLC];
        MatrixVLCTotLC(IndexVLC,1:20)=[FRClosedLC,FRCenterLC,FROpenLC];
        MatrixVLCTotMC(IndexVLC,1:20)=[FRClosedMC,FRCenterMC,FROpenMC];
        MatrixVLCTotHC(IndexVLC,1:20)=[FRClosedHC,FRCenterHC,FROpenHC];
        IndexVLC=IndexVLC+1;
    elseif statsLC.p(1,2)<=0.05 && mean(FROpenLC)>mean(FRClosedLC) && ((stats2LC.p(1,2)<=0.05 && mean(FROpenLC)>mean(FRCenterLC)) || stats2LC.p(1,2)>0.05)
        ...
        MatrixLCTot(IndexLC,1:20)=[FRClosedLC,FRCenterLC,FROpenLC];
        MatrixLCTotNC(IndexLC,1:20)=[FRClosedNC,FRCenterNC,FROpenNC];
        MatrixLCTotVLC(IndexLC,1:20)=[FRClosedVLC,FRCenterVLC,FROpenVLC];
        MatrixLCTotMC(IndexLC,1:20)=[FRClosedMC,FRCenterMC,FROpenMC];
        MatrixLCTotHC(IndexLC,1:20)=[FRClosedHC,FRCenterHC,FROpenHC];
        IndexLC=IndexLC+1;
    elseif statsMC.p(1,2)<=0.05 && mean(FROpenMC)>mean(FRClosedMC) && ((stats2MC.p(1,2)<=0.05 && mean(FROpenMC)>mean(FRCenterMC)) || stats2MC.p(1,2)>0.05)
        ...
        MatrixMCTot(IndexMC,1:20)=[FRClosedMC,FRCenterMC,FROpenMC];
        MatrixMCTotNC(IndexMC,1:20)=[FRClosedNC,FRCenterNC,FROpenNC];
        MatrixMCTotLC(IndexMC,1:20)=[FRClosedLC,FRCenterLC,FROpenLC];
        MatrixMCTotVLC(IndexMC,1:20)=[FRClosedVLC,FRCenterVLC,FROpenVLC];
        MatrixMCTotHC(IndexMC,1:20)=[FRClosedHC,FRCenterHC,FROpenHC];
        IndexMC=IndexMC+1;
    elseif statsHC.p(1,2)<=0.05 && mean(FROpenHC)>mean(FRClosedHC) && ((stats2HC.p(1,2)<=0.05 && mean(FROpenHC)>mean(FRCenterHC)) || stats2HC.p(1,2)>0.05)
        ...
        MatrixHCTot(IndexHC,1:20)=[FRClosedHC,FRCenterHC,FROpenHC];
        MatrixHCTotNC(IndexHC,1:20)=[FRClosedNC,FRCenterNC,FROpenNC];
        MatrixHCTotLC(IndexHC,1:20)=[FRClosedLC,FRCenterLC,FROpenLC];
        MatrixHCTotMC(IndexHC,1:20)=[FRClosedMC,FRCenterMC,FROpenMC];
        MatrixHCTotVLC(IndexHC,1:20)=[FRClosedVLC,FRCenterVLC,FROpenVLC];
        IndexHC=IndexHC+1;
    end
