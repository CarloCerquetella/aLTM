function ConfigSessionsLinearScalingOnlyBehaviour
rng shuffle
...
for i = 1:25
    ...
    switch v2(1,i)
        ...
        case 9
            B = 'Baseline';
        case 10
            B = 'Open Level 3 Narrower B2';
        case 11
            B = 'Baseline';
        case 12
            B = 'Open Level 4 Narrower B1';
        case 13
            B = 'Baseline';
        case 14
            B = 'Open Level 4 Narrower B1 with panels';
        case 15
            B = 'Baseline';
        case 16
            B = 'Open Level 3 Narrower B2 with panels';
        case 17
            B = 'Baseline';
        case 18
